...
const mockProjects: Project[] = [
  {
    ...
    pm: {
      name: "Sarah Chen",
      avatar:
        "https://images.unsplash.com/photo-1494790108755-2616c4c57c7a?w=150&h=150&fit=crop&crop=face",
    },
    teamSize: 5,
    duration: "6 weeks",
    progress: 67,
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Guide and support product management teams through their learning
              journey
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="text-sm">
                        Sarah Chen submitted wireframes for milestone 4
                      </p>
                      <p className="text-xs text-muted-foreground">
                        2 hours ago
                      </p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="text-sm">
                        Michael Rodriguez completed market research
                      </p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <p className="text-sm">
                        Emily Johnson requested feedback on final presentation
                      </p>
                      <p className="text-xs text-muted-foreground">
                        2 days ago
                      </p>
