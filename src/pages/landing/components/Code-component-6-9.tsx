...
export function Dashboard({
  ...
  const stats = {
    totalProjects: 1,
    completedMilestones: Array.isArray(currentProject?.completedMilestones)
      ? currentProject.completedMilestones.length
      : currentProject?.completedMilestones || 0,
    totalMilestones: Array.isArray(currentProject?.milestones)
      ? currentProject.milestones.length
      : currentProject?.milestones || 0,
    points: 0,
  ...
  const totalMilestones: number = Array.isArray(stats.totalMilestones)
    ? stats.totalMilestones.length
